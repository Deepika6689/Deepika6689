...
🔹 Machine learning model to predict heart disease risk from medical data.  
...
🔗 GitHub: https://github.com/Deepika6689/Heart-Disease-Prediction-

---

### 🌿 Plant Disease Detection (Smart AgroVision)  
🔹 CNN-based system to classify **33 types of plant leaf diseases**.  
...
**Purpose:** Early disease detection to support farmers and improve crop health.  

🔗 GitHub: https://github.com/Deepika6689/Smart-AgroVision  

---

### 🐜 Insect & Pest Detection in Stored Grains (NAIN Project)  
🔹 Real-time pest detection using image processing.  
...
📌 Status: **Ongoing**  
🎯 Goal: Reduce post-harvest losses  

---

### 📊 Statistics Analytics Dashboard  
🔹 Interactive dashboard for visualizing and analyzing user statistics.  
...
🏅 Complete Python with DSA Bootcamp + LeetCode – Udemy  
🏅 Workshop: Transformation of Technical Innovation to Viable Business  
...
🏛️ Government of Karnataka – Funding & Incubation Program  
